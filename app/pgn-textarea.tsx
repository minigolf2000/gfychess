...
export function PGNTextarea(props: Props) {
  ...
  return (
    <>
      {loadingLichessUrl && (
        <div className="absolute mt-5 left-1/2 size-7 animate-spin border-4 border-blue-500 border-r-transparent rounded-full" />
      )}
      ...
      <div className="flex items-center mt-2.5 mb-4 flex-wrap h-9 overflow-hidden">
        <h3 className="text-xs tracking-tight text-neutral-700 my-2.5 mr-1">
          PGN examples
        </h3>
